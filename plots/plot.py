...
plt.title("Chinese Models: Supervised vs Unsupervised", fontweight="bold")
plt.xticks(rotation=20, ha="right")
...
plt.title("English Models: Supervised vs Unsupervised", fontweight="bold")
plt.xticks(rotation=20, ha="right")
plt.ylabel("Score", fontweight="bold")
plt.xlabel("Model", fontweight="bold")
plt.tight_layout()
...
plt.title("Hindi Models: Supervised vs Unsupervised", fontweight="bold")
plt.xticks(rotation=20, ha="right")
plt.ylabel("Score", fontweight="bold")
plt.xlabel("Model", fontweight="bold")
plt.tight_layout()
